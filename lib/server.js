...
module.exports = class Server {
  constructor(genres, difficulties) {
    ...
    this.server.get('/difficulties', (req, res, next) => difficulties.respondAll(req, res, next));
    this.server.get('/difficulties/:id', (req, res, next) => difficulties.respondById(req, res, next));
  }
